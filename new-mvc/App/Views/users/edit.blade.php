...
<form class="form-horizontal " action="{{BASE_URL}}users/update/{{$users->id}}" method="post" enctype="multipart/form-data">
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-6" style="margin-top: 30px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-8">
                        <input type="radio" name="status" value="1" {{$users->status == 1 ? 'checked' : ''}}> Kích Hoạt
                        <input type="radio" name="status" value="0" {{$users->status == 0 ? 'checked' : ''}}> Chưa kích hoạt
                    </div>
                </div>
            </div>
        </div>
